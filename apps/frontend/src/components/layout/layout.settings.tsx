...
// import { BillingComponent } from '@gitroom/frontend/components/billing/billing.component'; // Billing system disabled
...
// import { CheckPayment } from '@gitroom/frontend/components/layout/check.payment'; // Billing system disabled
...
export const LayoutSettings = ({ children }: { children: ReactNode }) => {
  ...
  return (
    <ContextWrapper user={user}>
      ...
      >
        <MantineWrapper>
          {/* CheckPayment component removed - billing system disabled */}
          <ToolTip />
          <ShowMediaBoxModal />
          <ShowLinkedinCompany />
          <MediaSettingsLayout />
